...
export const bot = {
  sendMessage(chatId, text, options = {}) {
    if (typeof chatId === 'object' && chatId !== null) {
      return telegramBot.api.sendMessage(chatId);
    }
  ...
  editMessageText(text, options = {}) {
    if (typeof text === 'object' && text !== null) {
      return telegramBot.api.editMessageText(text);
    }
  ...
  answerCallbackQuery(callbackQueryId, options = {}) {
    if (
      typeof callbackQueryId === 'object' &&
      callbackQueryId !== null
    ) {
      return telegramBot.api.answerCallbackQuery(callbackQueryId);
    }
